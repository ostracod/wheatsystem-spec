...
import { errorSpecification, instructionSpecification, functionSpecification } from "./instances.js";
...
export class FunctionPage extends SpecPage {
    
    constructor() {
        super("functions", [functionSpecification]);
    }
}
